...
REQUIRE_PROFILE_READY = False
PROFILE_STALE_MAX_HOURS = 36
RISK_FALLBACK_MIN_SL_PCT = 0.55
RISK_ABSOLUTE_MIN_SL_PCT = 0.05
TP_PROFILE_TOLERANCE = 0.85
...
WATCH_MIN_START_DISPLACEMENT_PCT = 0.0015
...
# پنجره واقعی معاملات خرد؛ جلوی استفاده از تریدهای قدیمی و تکرار یک snapshot را می‌گیرد.
OKX_MICRO_WINDOW_SECONDS = 10
OKX_MICRO_MIN_TRADES = 8
# خطاهای موقت شبکه/Rate limit نباید ارز را ۳۰ دقیقه از مدار خارج کنند.
